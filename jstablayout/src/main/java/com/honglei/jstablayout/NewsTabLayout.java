package com.honglei.jstablayout;
...
import com.honglei.jstablayout.util.AnimationUtils;
...
public class NewsTabLayout extends HorizontalScrollView {
    ...
    public NewsTabLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewsTabLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        ThemeUtils.checkAppCompatTheme(context);
        ...
        mTabStrip.setSelectedIndicatorWidth(
                a.getDimensionPixelSize(R.styleable.JSTabLayout_tabIndicatorWidth, 0));
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new NewsTabLayout.TabLayoutOnPageChangeListener(this);
            }
            ...
            if (mAdapterChangeListener == null) {
                mAdapterChangeListener = new NewsTabLayout.AdapterChangeListener();
            }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<NewsTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(NewsTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final NewsTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                if (mSelectedIndicatorWidth == 0) {
                    ...
                    int mIndicatorMiddle = (mIndicatorLeft + mIndicatorRight) / 2;
                    canvas.drawRect(mIndicatorMiddle - dpToPx(mSelectedIndicatorWidth / 2), getHeight() - mSelectedIndicatorHeight,
                            mIndicatorMiddle + dpToPx(mSelectedIndicatorWidth / 2), getHeight(), mSelectedIndicatorPaint);
                }
            }
        }
